                                      ...
                                      children: <Widget>[
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            // 2. Logika dan Tombol Kategori
                                            Builder(
                                              builder: (context) {
                                                String categoryButtonTitle = '';
                                                String title =
                                                    tubles.title
                                                        ?.toLowerCase() ??
                                                    '';
                                                ...
                                                if (title.contains('motor')) {
                                                  categoryButtonTitle = 'MOTOR';
                                                } else if (title.contains(
                                                  'mobil',
                                                )) {
                                                  categoryButtonTitle = 'MOBIL';
                                                }

                                                if (categoryButtonTitle
                                                    .isNotEmpty) {
                                                  return Padding(
                                                    padding:
                                                    ...
                                                    child: ElevatedButton(
                                                      onPressed: () {
                                                        // Aksi tombol untuk kategori bisa ditambahkan di sini
                                                        // Untuk saat ini, hanya mencetak ke konsol
                                                        print(
                                                          "Tombol ${categoryButtonTitle} ditekan untuk ${tubles.title}",
                                                        );
                                                      },
                                                      style: ElevatedButton.styleFrom(
                                                        backgroundColor:
                                                ...
                                                return SizedBox.shrink(); // Mengembalikan widget kosong jika tidak ada kategori yang cocok
                                              },
                                            ),
                                          ],
                                        ),
